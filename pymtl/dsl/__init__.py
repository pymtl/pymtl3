...
from Connectable  import Signal, Wire, InVPort, OutVPort, Const, Interface, MethodPort, CalleePort, CallerPort, MethodGuard
...
from ComponentLevel6 import ComponentLevel6, method_port
