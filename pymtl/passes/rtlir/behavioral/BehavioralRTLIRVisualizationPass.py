...
#=========================================================================
# Visualize BehavioralRTLIR using Graphviz packeage. The output graph is in PDF
# format. 
...
from BehavioralRTLIRType     import *
...
class BehavioralRTLIRVisualizationVisitor( BehavioralRTLIRNodeVisitor ):
  ...
  def visit_StructInst( s, node ):
    ...
    label = (table_header + table_body + table_opt + table_trail).format(struct=node.struct)
