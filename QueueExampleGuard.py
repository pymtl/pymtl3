from pymtl import *
from pclib.guarded import PipeQueue, BypassQueue

class QueuePlusOne( MethodsGuard ):

  def __init__( s ):
    s.recv = MethodPort()
    s.send = MethodPort() # to be connected
