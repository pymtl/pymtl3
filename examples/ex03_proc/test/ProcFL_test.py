...
def test_add_rand_delays( dump_vcd ):
  run_test( ProcFL, inst_add.gen_random_test, dump_vcd,
...
def test_and_rand_delays( dump_vcd ):
  run_test( ProcFL, inst_and.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sll_rand_delays( dump_vcd ):
  run_test( ProcFL, inst_sll.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srl_rand_delays( dump_vcd ):
  run_test( ProcFL, inst_srl.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_bne_rand_delays( dump_vcd ):
  run_test( ProcFL, inst_bne.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3)
...
def test_addi_rand_delays( dump_vcd ):
  run_test( ProcFL, inst_addi.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_lw_rand_delays( dump_vcd ):
  run_test( ProcFL, inst_lw.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sw_rand_delays( dump_vcd ):
  run_test( ProcFL, inst_sw.gen_random_test, dump_vcd,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_csr_rand_delays( dump_vcd ):
  run_test( ProcFL, inst_csr.gen_random_test, dump_vcd,
...
def test_xcel_rand_delays( dump_vcd ):
  run_test( ProcFL, inst_xcel.gen_multiple_test, dump_vcd,
            src_delay=3, sink_delay=10, mem_stall_prob=0.5, mem_latency=3)
