...
def update( func: Any ) -> None: ...
def update_ff( func: Any ) -> None: ...
def update_once( func: Any ) -> None: ...
...
class Signal(Generic[T_SignalDataType]):
  ...
  # for reading from one bit
  @overload
  def __getitem__( s, index: Signal[Any] ) -> Signal[Bits1]: ...
  ...
  # Assume no designs make use of the left shift operator
  # mypy should fall back to regular operators if no augmented operators are found
  # ^ these are mainly because i'm not sure about the return value of __iXX__ ops..

  # s <<= other is equivalent to
  # s = s.__ilshift__(other)
  # s = s.__lshift__(other)

  # def __lshift__( s, other: Signal[T_SignalDataType] ) -> Signal[T_SignalDataType]: ...

  # def __matmul__( s, other: Signal[T_SignalDataType] ) -> Signal[T_SignalDataType]: ...

  # def __ilshift__( s, other: Signal[T_SignalDataType] ) -> Signal[T_SignalDataType]: ...

  # def __imatmul__( s, other: Signal[T_SignalDataType] ) -> Signal[T_SignalDataType]: ...

  def __ilshift__( s, other: Signal[T_SignalDataType] ) -> Any: ...

  def __imatmul__( s, other: Signal[T_SignalDataType] ) -> Any: ...

  # @overload
  # def __eq__ ( s, other: object ) -> bool: ...
  # @overload
  # def __eq__ ( s, other: Signal[T_SignalDataType] ) -> Signal[Bits1]: ...
  def __eq__ ( s, other: Any ) -> Signal[Bits1]: ...

  # @overload
  # def __ne__ ( s, other: object ) -> bool: ...
  # @overload
  # def __ne__ ( s, other: Signal[T_SignalDataType] ) -> Signal[Bits1]: ...
  def __ne__ ( s, other: Any ) -> Signal[Bits1]: ...
