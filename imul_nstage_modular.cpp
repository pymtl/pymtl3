...
public:
  ...
  {
     imul.steps[8].in_.val = imul.val_preg[4].out;
     imul.steps[8].out.val = imul.val_preg[4].out;
     imul.steps[9].in_.val = imul.val_preg[4].out;
  ...
  {
     imul.steps[8].in_.a = imul.a_preg[4].out;
  ...
  {
     imul.steps[16].in_.val = imul.val_preg[8].out;
     imul.steps[16].out.val = imul.val_preg[8].out;
     imul.steps[17].in_.val = imul.val_preg[8].out;
  ...
  {
     imul.steps[20].in_.val = imul.val_preg[10].out;
     imul.steps[20].out.val = imul.val_preg[10].out;
     imul.steps[21].in_.val = imul.val_preg[10].out;
  ...
  void top_imul_val_preg_7__out_FANOUT_5()
  {
     ...
     imul.steps[14].out.val = imul.val_preg[7].out;
     imul.steps[15].in_.val = imul.val_preg[7].out;
  ...
  {
     imul.steps[0].in_.val = imul.val_preg[0].out;
     imul.steps[0].out.val = imul.val_preg[0].out;
     imul.steps[1].in_.val = imul.val_preg[0].out;
  ...
  {
     imul.steps[8].out.a = imul.steps[8].a_lsh.out;
     imul.steps[9].in_.a = imul.steps[8].a_lsh.out;
  ...
  {
     imul.steps[26].out.a = imul.steps[26].a_lsh.out;
     imul.steps[27].in_.a = imul.steps[26].a_lsh.out;
  ...
  {
     imul.steps[22].out.a = imul.steps[22].a_lsh.out;
     imul.steps[23].in_.a = imul.steps[22].a_lsh.out;
  ...
  {
     imul.steps[26].in_.val = imul.val_preg[13].out;
     imul.steps[26].out.val = imul.val_preg[13].out;
     imul.steps[27].in_.val = imul.val_preg[13].out;
  ...
  {
     imul.steps[22].in_.res = imul.res_preg[11].out;
